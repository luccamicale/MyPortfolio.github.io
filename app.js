...
document.getElementById('button-see').addEventListener('click', () => {
  ...
  document.getElementById('bootstrap-moda1').textContent = projects[0].languages3;
  ...
  document.getElementById('live-link1').textContent = projects[0].liveLink;
  document.getElementById('source-link1').textContent = projects[0].sourceLink;
...
document.getElementById('button-see-two').addEventListener('click', () => {
  ...
  document.getElementById('bootstrap-moda1').textContent = projects[1].languages3;
  ...
  document.getElementById('live-link1').textContent = projects[1].liveLink;
  document.getElementById('source-link1').textContent = projects[1].sourceLink;
...
document.getElementById('button-see-mypost').addEventListener('click', () => {
  ...
  document.getElementById('bootstrap-moda1').textContent = projects[3].languages3;
  ...
  document.getElementById('live-link1').textContent = projects[3].liveLink;
  document.getElementById('source-link1').textContent = projects[3].sourceLink;
